...
# Email Class
# Retrieves security information about the current patch. It also prints the information to
...
class EmailGenerator:
    ...
    # @param time_stamp, time retrieved from website
    # @return new_time_stamp, new structured time stamp for comparison 
    def format_time(self, time_stamp):
        
        # Time Struct for date and time of last patch update
    ...
    def get_security_info(self):
        ...
        # Used to skip positions in the links list. We don't want the first two
        i = 2
        # Used to specify security update
        security = False
        ...
        # Checks that last time checked < current patch time stamp
        ...
        while time_stamp >= self.Last_Time_Checked and time_stamp is not None:
            ...
            if corretto is not None:
                ...
                if version == self.Version[0:2]:
                    ...
                    # Don't need to continue looking
                    break
